...
from ..dependencies import get_account_recovery_usecase
from ..schemas import AccountRecoveryResumeRequest, AccountRecoveryRunRequest
...
account_recovery_run.__module__ = "ai_copilot.api"
account_recovery_resume.__module__ = "ai_copilot.api"
